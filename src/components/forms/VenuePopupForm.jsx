...
const VenuePopupForm = ({ openModal, setopenModal, selectedVenue }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const success = await saveToGoogleSheets(banquetData);
    ...
    return (
        <div className="fixed z-50 top-0 right-0 bottom-0 left-0 bg-black/80 w-full h-screen flex items-center justify-center" onClick={() => setopenModal(false)}>
            <div className="bg-white rounded-xl w-[90%] lg:w-[500px] p-5 lg:p-6 relative" onClick={(e) => e.stopPropagation()}>
                <p className='text-xl lg:text-2xl text-center mb-3 lg:mb-6 font-bold'>Book Your Table ({selectedVenue?.name})</p>
                <form onSubmit={handleSubmit}>

                    <input type="hidden" name="eventName" value={selectedVenue?.name || ''} />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-6 mb-1 lg:mb-3">
                        ...
                        <div>
                            <label className="block text-sm font-bold mt-1.5">Select Date</label>
                            <DatePicker
